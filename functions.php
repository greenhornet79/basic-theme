...
function basic_theme_setup() {
	 ...
	 * If you're building a theme based on Basic Theme, use a find and replace
	 * to change 'basic-theme' to the name of your theme in all the template files.
	 */
...
function basic_theme_scripts() {
	...
	wp_enqueue_script( 'basic-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'basic-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
